...
tap "microck/kagi", "https://github.com/Microck/homebrew-kagi"
...
tap "schpet/tap", trusted: { formulae: ["linea"] }
...
# A utility toolkit of most commonly used tools by software developers and IT professionals
brew "ksdme/tap/ut", trusted: true
# Agent-native Rust CLI for Kagi subscribers with JSON-first output
brew "microck/kagi/kagi", trusted: true
...
cask "obsidian"
# The official CLI for the OpenAI API.
